...
from scicite import AclCiteWorthinessDatasetReader, AclSectionTitleDatasetReader, SciciteSectitleDatasetReader, \
    SciCiteWorthinessDataReader
from scicite.helper import regex_find_citation

logger = logging.getLogger(__name__)  # pylint: disable=invalid-name


@DatasetReader.register("custom_scicite_section_title_data_reader")
class CustomSciciteSectitleDatasetReader(SciciteSectitleDatasetReader):
    ...
    @classmethod
    def from_params(cls, params: Params) -> 'CustomSciciteSectitleDatasetReader':
...
@DatasetReader.register("custom_scicite_cite_worthiness_data_reader")
class CustomSciCiteWorthinessDataReader(SciCiteWorthinessDataReader):
    ...
    @classmethod
    def from_params(cls, params: Params) -> 'CustomSciCiteWorthinessDataReader':
        lazy = params.pop('lazy', False)
        tokenizer = Tokenizer.from_params(params.pop('tokenizer', {}))
        with_elmo = params.pop_bool("with_elmo", False)
        with_bert = params.pop_bool("with_bert", False)
