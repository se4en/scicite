...
from scicite.scicite.training.multitask_trainer_two_tasks import MultiTaskTrainer2
from scicite.scicite.training.vocabulary_multitask import VocabularyMultitask
